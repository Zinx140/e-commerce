...
function next(query){
    let productSlideAll = document.querySelector(query)
    productSlideAll.scrollLeft += 450
    console.log(productSlideAll)
}
...
const productPage = document.querySelector('.product-scroll')
let acc = 0

for (let i = 0; i < barang.length; i++) {
    let card = document.createElement('div')
    card.className = `card position-relative mx-1 mb-5 col-4 col-md-2 ${barang[i].category}`
    let badge = document.createElement('span')
    badge.className = 'position-absolute badge bg-danger'
    badge.innerHTML = `${barang[i].promo}`
    let productImg = document.createElement('img')
    productImg.src = `${barang[i].gambar}`
    let productName = document.createElement('p')
    productName.id = 'product-name'
    productName.innerHTML = `${barang[i].nama}`
    let gimmick = document.createElement('p')
    gimmick.id = 'gimmick-price'
    gimmick.innerHTML = `<s>${barang[i].gimmick}</s> ${barang[i].promo}`
    let price = document.createElement('p')
    price.id = 'real-price'
    price.innerHTML =`${barang[i].price}`
    let button = document.createElement('a')
    button.innerHTML = 'Product Details'
    button.className = 'btn btn-primary'
    button.role = 'button'
    button.href = `detail.html?id=${i}`
    card.appendChild(badge)
    card.appendChild(productImg)
    card.appendChild(productName)
    card.appendChild(gimmick)
...
productPage.style.width = `${acc * 280}px`

const productPage1 = document.querySelector('.product-scroll-accessories')
acc = 0

for (let i = 0; i < barang.length; i++) {
    if (barang[i].category.includes('accessories')) {
        let card = document.createElement('div')
        card.className = `card position-relative mx-1 mb-5 col-4 col-md-2 ${barang[i].category}`
        let badge = document.createElement('span')
        badge.className = 'position-absolute badge bg-danger'
        ...
        card.appendChild(button)
        card.id = `${i}`
        productPage1.appendChild(card)
        acc++
    }
}

productPage1.style.width = `${acc * 280}px`

const productPage2 = document.querySelector('.product-scroll-hot')
acc = 0

for (let i = 0; i < barang.length; i++) {
    if (barang[i].category.includes('hot')) {
        let card = document.createElement('div')
        card.className = `card position-relative mx-1 mb-5 col-4 col-md-2 ${barang[i].category}`
        let badge = document.createElement('span')
        badge.className = 'position-absolute badge bg-danger'
        ...
        card.appendChild(button)
        card.id = `${i}`
        productPage2.appendChild(card)
        acc++
    }
}

productPage2.style.width = `${acc * 280}px`

const productPage3 = document.querySelector('.product-scroll-top')
acc = 0

for (let i = 0; i < barang.length; i++) {
    if (barang[i].category.includes('top')) {
        let card = document.createElement('div')
        card.className = `card position-relative mx-1 mb-5 col-4 col-md-2 ${barang[i].category}`
        let badge = document.createElement('span')
        badge.className = 'position-absolute badge bg-danger'
        ...
        card.appendChild(button)
        card.id = `${i}`
        productPage3.appendChild(card)
        acc++
    }
}

productPage3.style.width = `${acc * 280}px`

const productPage4 = document.querySelector('.product-scroll-phone')
acc = 0

for (let i = 0; i < barang.length; i++) {
    if (barang[i].category.includes('phone')) {
        let card = document.createElement('div')
        card.className = `card position-relative mx-1 mb-5 col-4 col-md-2 ${barang[i].category}`
        let badge = document.createElement('span')
        badge.className = 'position-absolute badge bg-danger'
        ...
        card.appendChild(button)
        card.id = `${i}`
        productPage4.appendChild(card)
        acc++
    }
}

productPage4.style.width = `${acc * 280}px`


const productPage5 = document.querySelector('.product-scroll-recomended')
acc = 0

for (let i = 0; i < barang.length; i++) {
    if (barang[i].category.includes('recomended')) {
        let card = document.createElement('div')
        card.className = `card position-relative mx-1 mb-5 col-4 col-md-2 ${barang[i].category}`
        let badge = document.createElement('span')
        badge.className = 'position-absolute badge bg-danger'
        ...
        card.appendChild(button)
        card.id = `${i}`
        productPage5.appendChild(card)
        acc++
    }
}

productPage5.style.width = `${acc * 280}px`

const productPage6 = document.querySelector('.product-scroll-special')
acc = 0

for (let i = 0; i < barang.length; i++) {
    if (barang[i].category.includes('special')) {
        let card = document.createElement('div')
        card.className = `card position-relative mx-1 mb-5 col-4 col-md-2 ${barang[i].category}`
        let badge = document.createElement('span')
        badge.className = 'position-absolute badge bg-danger'
        ...
        card.appendChild(button)
        card.id = `${i}`
        productPage6.appendChild(card)
        acc++
    }
}

productPage6.style.width = `${acc * 280}px`

const productPage7 = document.querySelector('.product-scroll-discount')
acc = 0

for (let i = 0; i < barang.length; i++) {
    if (barang[i].category.includes('discount')) {
        let card = document.createElement('div')
        card.className = `card position-relative mx-1 mb-5 col-4 col-md-2 ${barang[i].category}`
        let badge = document.createElement('span')
        badge.className = 'position-absolute badge bg-danger'
        ...
        card.appendChild(button)
        card.id = `${i}`
        productPage7.appendChild(card)
        acc++
    }
}

productPage7.style.width = `${acc * 280}px`